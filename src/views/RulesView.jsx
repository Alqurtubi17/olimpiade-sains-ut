...
const DEFAULT_RULES = {
  ...
  rebutanItems: [
    ...
    "Jika jawaban dinyatakan tidak sempurna maka jawaban dinyatakan salah dan tim yang bersangkutan mendapatkan pengurangan nilai 50 poin.",
    "Jika ada peserta yang menekan bel namun sama sekali tidak memberikan jawaban, tim yang bersangkutan mendapatkan pengurangan nilai 50 poin.",
